  ...
  return <>
    <div className="page-head">
      <div>
        ...
        <h1>Settings</h1>
        <p>Manage your own accounts and AI preferences here. Profile and family links are managed from Profile.</p>
      </div>
    </div>
    ...
    <div className="grid2">
      <section className="card">
        <h2>Bank accounts</h2>
        <p>These accounts belong only to your Ledger user.</p>
      ...
      <section className="card">
        ...
        <label>API key
          <input
            type="password"
            value={s.api_key||''}
            placeholder={s.has_api_key?'Stored securely — enter to replace':'Optional for local; required for Gemini'}
